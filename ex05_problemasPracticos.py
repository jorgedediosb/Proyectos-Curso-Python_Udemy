...
def devolver_distintos(num1, num2, num3):
    if num1 + num2 + num3 > 15:
        ...
        return (num1, num2, num3)[1] #[1] es el nº intermedios de los 3 (posición 2) 
...
# Función que requiera un solo argumento numérico.
# Mostrar en pantalla todos los números primos existentes en el rango que va desde cero hasta ese número incluido,
...
def contar_primos(num):
    ...
    for num in range(2, num + 1): #nºs a partir de 2
        es_primo = True
        for i in range(2, int(num ** 0.5) + 1): #verificar si "num" es divisible por algún número entre 2 y su raíz cuadrada
...
print("Cantidad de números primos encontrados:", cantidad)